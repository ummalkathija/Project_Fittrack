export function CalendarIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M8 7h8M7 3v4m10-4v4M5 7h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2z" />
    </svg>
  );
}
...
export function SparklesIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path d="M5 8l2 2-2 2-2-2 2-2zm14-2l2 3-2 3-2-3 2-3zM12 6l2 4-2 4-2-4 2-4z" />
    </svg>
  );
}
...
export function DumbbellIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M4 10v4m3-6v8m10-8v8m3-6v4M9 12h6" />
    </svg>
  );
}
...
export function LotusIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path d="M12 20c4 0 7-3 7-7 0-4-3-7-7-7-4 0-7 3-7 7 0 4 3 7 7 7z" />
    </svg>
  );
}